...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy for Xhosen Gate - Learn how we protect and handle your personal information.',
};
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mb-12">
                            <p className="text-gray-600 text-lg leading-relaxed">
                                At Xhosen Gate, we are committed to protecting your privacy and ensuring the security of your personal information.
                        ...
                        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 text-gray-700">
                                    ...
                                    <a href="mailto:privacy@xhosengate.com" className="hover:text-primary transition-colors">
                                        privacy@xhosengate.com
                                    </a>
                                </div>
                                <div className="flex items-center gap-3 text-gray-700">
