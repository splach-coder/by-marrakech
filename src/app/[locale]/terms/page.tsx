...
export const metadata: Metadata = {
    title: 'Terms of Service | Xhosen Gate',
    description: 'Terms and Conditions for using Xhosen Gate travel services.',
};
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mb-12 bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                            <p className="text-gray-700 leading-relaxed">
                                These Terms of Service ("Terms") govern your use of Xhosen Gate's website and services. By accessing our website
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4">
                                <p className="text-gray-600">Xhosen Gate provides:</p>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="bg-gray-100 border-l-4 border-gray-900 p-6 rounded-r-xl">
                                <p className="text-gray-700 leading-relaxed mb-4">
                                    Xhosen Gate acts as an intermediary between travelers and service providers. While we carefully select our partners,
                        ...
                        <div className="mb-12">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                All content on this website, including text, graphics, logos, images, and software, is the property of Xhosen Gate
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-8">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <a href="mailto:info@xhosengate.com" className="hover:text-primary transition-colors">
                                        info@xhosengate.com
                                    </a>
                                </div>
                                <div className="flex items-center gap-3">
